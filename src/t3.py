...
# 算法变量设置
# 总仿真次数
def MultiSdFth(count=1,x = np.arange(0.55, 0.95, 0.05),sumreq = 400,link_capacity = 50,norfSD_Pair = 4,topology_fidelity_mode = 0,read_random_SDpair=0,random_topology = 0,random_topology_mode=0,random_topology_nodes_num = 10):
    """
    count = 1
    #本次仿真中启用的对比算法
